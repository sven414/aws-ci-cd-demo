...
Projektet hostas på AWS. För detta används tjänsten Elastic Beanstalk som plattform och EC2 som server. Appen använder även en databas som finns på AWS RDS. I projektet ingår en CI/CD-pipeline som bygger och distribuerar projektet automatiskt vid push eller pull request till main-branchen på GitHub. Översikt:

Adressen till API:t är: http://bookapi.eu-north-1.elasticbeanstalk.com
Adressen till Swagger är: http://bookapi.eu-north-1.elasticbeanstalk.com/swagger-ui/index.html
...
Den andra policyn har jag fått skriva själv:
```JSON
{
	"Version": "2012-10-17",
	"Statement": [
